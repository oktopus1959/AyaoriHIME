...
namespace KanchokuWS.Gui
{
    public partial class DlgSettings
    {
        ...
        private void button_defaultLogLevel_Click(object sender, EventArgs e)
        {
            ...
            checkBox_multiStreamDetailLog.Checked = false;
        }
        ...
        private void initializeAboutDgv()
        {
            ...
            dgvAbout.Rows[iRow++].Cells[1].Value = $"{KanchokuWS.ProductVersion.ProductName} - {KanchokuWS.ProductVersion.Version}";
            dgvAbout.Rows[iRow].Cells[0].Value = "別名";
            dgvAbout.Rows[iRow++].Cells[1].Value = $"{KanchokuWS.ProductVersion.ProductKanjiName} - {KanchokuWS.ProductVersion.ProductExplanation} {KanchokuWS.ProductVersion.ProductExplanation2}";
        ...
        private void button_displayKeyInfos_Click(object sender, EventArgs e)
        {
