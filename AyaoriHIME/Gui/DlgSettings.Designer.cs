...
namespace KanchokuWS.Gui
{
    ...
    "ス\r\nなどの上にマウスポインタを置くとツールチップが表示されます。";
        ...
        "候補の両方を有効にします。\r\n\r\n複数テーブル使用時は、この設定は常にONとなります。");
            ...
            this.checkBox_strokeBackByBS.Size = new System.Drawing.Size(144, 19);
        ...
        "\r\n末尾の文字を直接削除するようになります。\r\n\r\n0 に設定すると、「BSを本来の動作に戻す」をONにしない\r\n限り、本来のBS動作には戻りません。");
            ...
            this.label46.Location = new System.Drawing.Point(175, 42);
            this.label46.Name = "label46";
            this.label46.Size = new System.Drawing.Size(158, 15);
            this.label46.TabIndex = 77;
            this.label46.Text = "連続BS後に本来の動作に戻す)";
            // 
            // label159
            // 
