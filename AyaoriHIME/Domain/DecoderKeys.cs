...
namespace KanchokuWS
{
    ...
    public static partial class DecoderKeys
    {
        ...
        public const int HISTORY_NEXT_SEARCH_DECKEY = HISTORY_FULL_CAND_DECKEY + 1;         // 履歴検索実行&次候補選択キー（2枠は予約欠番）
        ...
        public const int ONESHOT_ZENKAKU_CONVERSION_DECKEY = BUSHU_COMP_DECKEY + 1;                     // ワンショット全角変換
        public const int ONESHOT_KATAKANA_CONVERSION_DECKEY = ONESHOT_ZENKAKU_CONVERSION_DECKEY + 1;    // ワンショットカタカナ変換

        public const int TOGGLE_ZENKAKU_CONVERSION_DECKEY = ONESHOT_KATAKANA_CONVERSION_DECKEY + 1;     // 全角変換のトグル
