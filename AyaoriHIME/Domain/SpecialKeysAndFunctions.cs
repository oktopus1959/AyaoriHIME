...
namespace KanchokuWS
{
    ...
    public static class SpecialKeysAndFunctions
    {
        ...
        private static KeyOrFunction[] specialKeysAndFunctions = new KeyOrFunction[] {
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F1_DECKEY, 0, "Fn1", "", "F1 キー", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F2_DECKEY, 0, "Fn2", "", "F2 キー", "fn2"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F3_DECKEY, 0, "Fn3", "", "F3 キー", "fn3"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F4_DECKEY, 0, "Fn4", "", "F4 キー", "fn4"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F5_DECKEY, 0, "Fn5", "", "F5 キー", "fn5"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F6_DECKEY, 0, "Fn6", "", "F6 キー", "fn6"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F7_DECKEY, 0, "Fn7", "", "F7 キー", "fn7"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F8_DECKEY, 0, "Fn8", "", "F8 キー", "fn8"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F9_DECKEY, 0, "Fn9", "", "F9 キー", "fn9"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F10_DECKEY, 0, "Fn10", "", "F10 キー", "fn10"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F11_DECKEY, 0, "Fn11", "", "F11 キー", "fn11"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F12_DECKEY, 0, "Fn12", "", "F12 キー", "fn12"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F13_DECKEY, 0, "Fn13", "", "F13 キー", "fn13"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F14_DECKEY, 0, "Fn14", "", "F14 キー", "fn14"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F15_DECKEY, 0, "Fn15", "", "F15 キー", "fn15"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F16_DECKEY, 0, "Fn16", "", "F16 キー", "fn16"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F17_DECKEY, 0, "Fn17", "", "F17 キー", "fn17"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F18_DECKEY, 0, "Fn18", "", "F18 キー", "fn18"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F19_DECKEY, 0, "Fn19", "", "F19 キー", "fn19"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F20_DECKEY, 0, "Fn20", "", "F20 キー", "fn20"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F21_DECKEY, 0, "Fn21", "", "F21 キー", "fn21"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F22_DECKEY, 0, "Fn22", "", "F22 キー", "fn22"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F23_DECKEY, 0, "Fn23", "", "F23 キー", "fn23"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F24_DECKEY, 0, "Fn24", "", "F24 キー", "fn24"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_SELECT_FIRST_DECKEY, 0, "MultiStreamSelectFirst", "", "漢直・かな配列の融合時に、先頭候補を選択"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_COMMIT_DECKEY, 0, "MultiStreamCommit", "", "漢直・かな配列の融合時に、先頭候補だけを残して初期化する"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_HIRAGANA_PREFERRED_NEXT_DECKEY, 0, "MultiStreamHiraganaPreferredNext", "", "漢直・かな配列の融合時に、次の打鍵ではひらがなのみを通す"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_KANJI_PREFERRED_NEXT_DECKEY, 0, "MultiStreamKanjiPreferredNext", "", "漢直・かな配列の融合時に、次の打鍵では漢字のみを通す"),
