...
namespace KanchokuWS
{
    ...
    public static class SpecialKeysAndFunctions
    {
        ...
        private static KeyOrFunction[] specialKeysAndFunctions = new KeyOrFunction[] {
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.INS_DECKEY, 0, "Insert", "", "Insert キー", "ins", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.DEL_DECKEY, 0, "Delete", "", "Delete キー", "del", "fn1"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.PAGE_UP_DECKEY, 0, "PageUp", "", "Page Up キー", "pgup", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.PAGE_DOWN_DECKEY, 0, "PageDown", "", "Page Down キー", "pgdn", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.LEFT_ARROW_DECKEY, 0, "Left", "", "← キー", "leftarrow", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.RIGHT_ARROW_DECKEY, 0, "Right", "", "→ キー", "rightarrow", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.UP_ARROW_DECKEY, 0, "Up", "", "↑ キー", "uparrow", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.DOWN_ARROW_DECKEY, 0, "Down", "", "↓ キー", "downarrow", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.SCR_LOCK_DECKEY, 0, "ScrLock", "", "Scroll Lock キー", "scrlock", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.PAUSE_DECKEY, 0, "Pause", "", "Pause キー", "pause", "fn1"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.LEFT_ALT_DECKEY, KeyModifiers.MOD_LALT, "LAlt", "左Alt", "左Alt キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.RIGHT_ALT_DECKEY, KeyModifiers.MOD_RALT, "RAlt", "右Alt", "右Alt キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.LEFT_WIN_DECKEY, KeyModifiers.MOD_LWIN, "LWin", "左Win", "左Win キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.RIGHT_WIN_DECKEY, KeyModifiers.MOD_RWIN, "RWin", "右Win", "右Win キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIER, -1, KeyModifiers.MOD_SHIFT, "shift", "シフト", "シフト キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F1_DECKEY, 0, "F1", "", "F1 キー", "f01", "fn1"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F2_DECKEY, 0, "F2", "", "F2 キー", "f02", "fn2"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F3_DECKEY, 0, "F3", "", "F3 キー", "f03", "fn3"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F4_DECKEY, 0, "F4", "", "F4 キー", "f04", "fn4"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F5_DECKEY, 0, "F5", "", "F5 キー", "f05", "fn5"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F6_DECKEY, 0, "F6", "", "F6 キー", "f06", "fn6"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F7_DECKEY, 0, "F7", "", "F7 キー", "f07", "fn7"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F8_DECKEY, 0, "F8", "", "F8 キー", "f08", "fn8"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F9_DECKEY, 0, "F9", "", "F9 キー", "f09", "fn9"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F10_DECKEY, 0, "F10", "", "F10 キー", "f10", "fn10"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F11_DECKEY, 0, "F11", "", "F11 キー", "f11", "fn11"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F12_DECKEY, 0, "F12", "", "F12 キー", "f12", "fn12"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F13_DECKEY, 0, "F13", "", "F13 キー", "f13", "fn13"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F14_DECKEY, 0, "F14", "", "F14 キー", "f14", "fn14"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F15_DECKEY, 0, "F15", "", "F15 キー", "f15", "fn15"),
            new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F16_DECKEY, 0, "F16", "", "F16 キー", "f16", "fn16"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F17_DECKEY, 0, "F17", "", "F17 キー", "f17", "fn17"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F18_DECKEY, 0, "F18", "", "F18 キー", "f18", "fn18"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F19_DECKEY, 0, "F19", "", "F19 キー", "f19", "fn19"),
            //new KeyOrFunction(KeyOrFunction.ATTR_MODIFIEE, DecoderKeys.F20_DECKEY, 0, "F20", "", "F20 キー", "f20", "fn20"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_NEXT_CAND_DECKEY, 0, "MultiStreamNext", "", "配列融合時の次候補選択"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.SIMPLE_DIC_NEXT_SEARCH_DECKEY, 0, "SimpleDicNext", "", "簡易辞書検索候補を先頭から選択"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.SIMPLE_DIC_PREV_SEARCH_DECKEY, 0, "SimpleDicPrev", "", "簡易辞書検索候補を末尾から選択"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.FULL_ESCAPE_DECKEY, 0, "FullEscape", "", "入力途中状態をクリアし、入力文字列の末尾にブロッカーを置く"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.UNBLOCK_DECKEY, 0, "Unblock", "", "入力文字列の末尾のブロッカーを解除する"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.TOGGLE_BLOCKER_DECKEY, 0, "BlockerToggle", "", "入力文字列の末尾のブロッカーを設定・解除する", "toggleblocker"),
            ...
            //new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.TOGGLE_KATAKANA_CONVERSION2_DECKEY, 0, "KatakanaModeToggle2", "", "副テーブルを選択してカタカナ入力モードのON/OFF"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.COPY_SELECTION_AND_SEND_TO_DICTIONARY_DECKEY, 0, "CopyAndRegisterSelection", "", "選択されている部分をデコーダの簡易辞書に送って登録",
                "copyselectionandsendtodictionary", null, 
                "アクティブウィンドウに Ctrl-C を送りつけて、選択されている部分をクリップボードにコピーし、\nそれをデコーダの簡易辞書に送って登録する"),
