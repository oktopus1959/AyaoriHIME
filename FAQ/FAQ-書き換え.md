...
漢織媛を素で使用している場合は、下図のように「ブロッカー設定/解除」に適当なキーを割り当て、
それを打鍵してください。
...
## Google日本語入力と互換にしたい
漢織媛のデフォルト設定では、8文字までの任意の末尾文字列が書き換え対象となります。
...
漢織媛を使用せず、直接Google日本語入力上でかな配列を利用したい場合は、
...
漢織媛上でかな配列を試行錯誤して、ある程度固まったらローマ字テーブルを出力し、
