...
このように選択肢のペアとなるエントリを登録しておくと、このペア間で候補選択をしてもボーナスポイントの加減算が行われなくなります。つまり「迎え」には常に5ボーナスポイントが加算され、「抑え」にはその加算がない、ということになるわけです。これにより、「迎え」を含む候補が優先的に出力されるようになり、「抑え」を選択したとしても優先度には変化がない、ということになります。
