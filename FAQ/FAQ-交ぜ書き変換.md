...
- [ユーザー辞書登録](#ユーザー辞書登録)
    - [「馬鹿馬鹿しい,ばかばかしい,形容詞」を登録したら展開後行数が224行になりました](#馬鹿馬鹿しいばかばかしい形容詞を登録したら展開後行数が224行になりました)
...
## ユーザー辞書登録
「交ぜ書き・書き換え」タブを開き、「交ぜ書きユーザー辞書」の「開く」をクリックします。<br>
...
記述に間違いがあると、現状、次のようにエラー箇所を表示します。 (区切り文字として `,` ではなく `、` が使われている)<br>
![alt text](image/mazegaki-dic-import-error.png)

### 「馬鹿馬鹿しい,ばかばかしい,形容詞」を登録したら展開後行数が224行になりました
...
上述の「馬鹿馬鹿しい,ばかばかしい」のケースでは、馬→ば、鹿→か、と容易に推定できますが、推定の難しいものもあります。
...
もう一つ、「山茶花,さざんか」の例。これは末尾の「か,花」しか推定できないので、次のように展開されます。
```
山茶花,山茶花,
山茶花,さざん花
山茶花,山茶か
