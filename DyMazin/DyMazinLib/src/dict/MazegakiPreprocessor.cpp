...
namespace MazegakiPreprocessor {
    ...
    */
    ...
    std::map<String, String> ktypeDefs = {
        ...
        { L"四段く",   L"836,836,X,動詞,自立,*,*,四段・カ行,基本形" },
        { L"四段ぐ",   L"836,836,X,動詞,自立,*,*,四段・ガ行,基本形" },
        { L"四段す",   L"836,836,X,動詞,自立,*,*,四段・サ行,基本形" },
        { L"四段つ",   L"841,841,X,動詞,自立,*,*,四段・タ行,基本形" },
        { L"四段ぬ",   L"841,841,X,動詞,自立,*,*,四段・ナ行,基本形" },
        { L"四段ふ",   L"846,846,X,動詞,自立,*,*,四段・ハ行,基本形" },
        { L"四段ぶ",   L"851,851,X,動詞,自立,*,*,四段・バ行,基本形" },
        { L"四段む",   L"851,851,X,動詞,自立,*,*,四段・マ行,基本形" },
        { L"四段る",   L"851,851,X,動詞,自立,*,*,四段・ラ行,基本形" },
    ...
    std::map<String, VectorString> kformDefs = {
        ...
        // 四段・カ行
        { L"四段・カ行",
            { L"基本形,く,836", L"未然形,か,837", L"連用形,き,839", L"仮定形,け,835", L"命令ｅ,け,838" }
        },

        // 四段・ガ行
        { L"四段・ガ行",
            { L"基本形,ぐ,836", L"未然形,が,837", L"連用形,ぎ,839", L"仮定形,げ,835", L"命令ｅ,げ,838" }
        },

        // 四段・サ行
        { L"四段・サ行",
            { L"基本形,す,836", L"未然形,さ,837", L"連用形,し,839", L"仮定形,せ,835", L"命令ｅ,せ,838" }
        },

        // 四段・タ行
        { L"四段・タ行",
            { L"基本形,つ,841", L"未然形,た,842", L"連用形,ち,844", L"仮定形,て,840", L"命令ｅ,て,843" }
        },

        // 四段・ナ行
        { L"四段・ナ行",
            { L"基本形,ぬ,841", L"未然形,な,842", L"連用形,に,844", L"仮定形,ね,840", L"命令ｅ,ね,843" }
        },

        // 四段・ハ行
        { L"四段・ハ行",
            { L"基本形,ふ,846", L"未然形,は,847", L"連用形,ひ,849", L"仮定形,へ,845", L"命令ｅ,へ,848" }
        },

        // 四段・バ行
        { L"四段・バ行",
            { L"基本形,ぶ,851", L"未然形,ば,852", L"連用形,び,854", L"仮定形,べ,850", L"命令ｅ,べ,853" }
        },

        // 四段・マ行
        { L"四段・マ行",
            { L"基本形,む,851", L"未然形,ま,852", L"連用形,み,854", L"仮定形,め,850", L"命令ｅ,め,853" }
        },

        // 四段・ラ行
        { L"四段・ラ行",
            { L"基本形,る,851", L"未然形,ら,852", L"連用形,り,854", L"仮定形,れ,850", L"命令ｅ,れ,853" }
        },
