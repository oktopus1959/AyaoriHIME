...
#define MY_NODE ((PostRewriteOneShotNode*)pNode)
        ...
        void GetResultString(MStringResult& resultOut) {
            ...
            if (rewInfo && rewInfo->subTable) {
                _LOG_DEBUGH(_T("REWRITE SubTable: outStr={}, rewritableLen={}, subTable={:p}"), to_wstr(rewInfo->rewriteStr), rewInfo->rewritableLen, (void*)rewInfo->subTable, resultOut.numBS());
