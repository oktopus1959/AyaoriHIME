...
// このファイルは ./tools/make_deckey_id_def.sh により Ayaorihime/Domain/DecoderKeys.cs から自動的に作成されました (2026/07/31 09:32:30)
#pragma once
...
#define SHIFT_B_DECKEY_START (SHIFT_A_DECKEY_START + PLANE_DECKEY_NUM)

// SHIFT_C修飾DECKEYの始まり (400)
#define SHIFT_C_DECKEY_START (SHIFT_B_DECKEY_START + PLANE_DECKEY_NUM)

// SHIFT_D修飾DECKEYの始まり (500)
#define SHIFT_D_DECKEY_START (SHIFT_C_DECKEY_START + PLANE_DECKEY_NUM)

// SHIFT_E修飾DECKEYの始まり (600)
#define SHIFT_E_DECKEY_START (SHIFT_D_DECKEY_START + PLANE_DECKEY_NUM)

// SHIFT_F修飾DECKEYの始まり (700)
#define SHIFT_F_DECKEY_START (SHIFT_E_DECKEY_START + PLANE_DECKEY_NUM)
...
#define ORDERED_COMBO_DECKEY_END (ORDERED_COMBO_DECKEY_START + PLANE_DECKEY_NUM)

// カバリング(StackLike)同時打鍵用修飾DECKEYの始まり (1000)
#define STACKLIKE_COMBO_DECKEY_START (ORDERED_COMBO_DECKEY_END)
#define COVERING_COMBO_DECKEY_START (STACKLIKE_COMBO_DECKEY_START)

// カバリング(StackLike)同時打鍵用修飾DECKEYの終わり(の次) (1100)
#define STACKLIKE_COMBO_DECKEY_END (STACKLIKE_COMBO_DECKEY_START + PLANE_DECKEY_NUM)
#define COVERING_COMBO_DECKEY_END (STACKLIKE_COMBO_DECKEY_END)

// 同時打鍵用修飾DECKEYの終わり(の次) (1100)
#define COMBO_DECKEY_END (STACKLIKE_COMBO_DECKEY_END)
...
#define LEFT_ALT_DECKEY (RIGHT_SHIFT_DECKEY + 1)
#define RIGHT_ALT_DECKEY (LEFT_ALT_DECKEY + 1)
#define LEFT_WIN_DECKEY (RIGHT_ALT_DECKEY + 1)
#define RIGHT_WIN_DECKEY (LEFT_WIN_DECKEY + 1)
#define F1_DECKEY (RIGHT_WIN_DECKEY + 1)
...
#define SHIFT_TAB_DECKEY (F16_DECKEY + 1)
// これでもう満杯である
...
#define SIMPLE_DIC_NEXT_SEARCH_DECKEY (COMMIT_STATE_DECKEY + 1)
#define SIMPLE_DIC_PREV_SEARCH_DECKEY (SIMPLE_DIC_NEXT_SEARCH_DECKEY + 1)

#define STROKE_HELP_DECKEY (SIMPLE_DIC_PREV_SEARCH_DECKEY + 1)
#define BUSHU_COMP_HELP_DECKEY (STROKE_HELP_DECKEY + 1)

#define BUSHU_COMP_DECKEY (BUSHU_COMP_HELP_DECKEY + 1)

#define ONESHOT_ZENKAKU_CONVERSION_DECKEY (BUSHU_COMP_DECKEY + 1)
#define ONESHOT_KATAKANA_CONVERSION_DECKEY (ONESHOT_ZENKAKU_CONVERSION_DECKEY + 1)

#define TOGGLE_ZENKAKU_CONVERSION_DECKEY (ONESHOT_KATAKANA_CONVERSION_DECKEY + 1)
...
#define MULTI_STREAM_KANJI_PREFERRED_NEXT_DECKEY (MULTI_STREAM_COMMIT_DECKEY + 1)
#define MULTI_STREAM_HIRAGANA_PREFERRED_NEXT_DECKEY (MULTI_STREAM_KANJI_PREFERRED_NEXT_DECKEY + 1)

#define STROKE_BACK_DECKEY (MULTI_STREAM_HIRAGANA_PREFERRED_NEXT_DECKEY + 1)
#define FLUSH_OUTPUT_STRING_DECKEY (STROKE_BACK_DECKEY + 1)
#define EDIT_WINDOW_TOGGLE_DECKEY (FLUSH_OUTPUT_STRING_DECKEY + 1)

#define UNDEFINED_DECKEY (EDIT_WINDOW_TOGGLE_DECKEY + 1)
