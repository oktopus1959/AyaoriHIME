...
namespace KanchokuWS
{
    static class Program
    {
        ...
        {
            Logger.LogFilename = $"{KanchokuWS.ProductVersion.ProductName}.log";
    ...
    {
        static string mutexName = $"{KanchokuWS.ProductVersion.ProductName}-4C1B35AB-0759-41C0-9109-FFFDCE2A0621";
